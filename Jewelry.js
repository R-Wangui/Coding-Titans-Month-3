...
async function getOneProduct() {
    const data = await fetch("https://fakestoreapi.com/products/category/jewelery/1");
  ...
  async function getProducts(amount) {
    const data = await fetch(`https://fakestoreapi.com/products/category/jewelery?limit=${amount}`);
    const res = await data.json();
