 ...
 async function getOneProduct() {
    const data = await fetch("https://fakestoreapi.com/products/category/women'sclothing/1");
  ...
  async function getProducts(amount) {
    const data = await fetch(`https://fakestoreapi.com/products/category/women'sclothing?limit=${amount}`);
    const res = await data.json();
