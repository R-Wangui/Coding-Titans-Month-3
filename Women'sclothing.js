 ...
 async function getOneProduct() {
    const data = await fetch("https://fakestoreapi.com/products/category/women's%20clothing/1");
  ...
  async function getProducts(amount) {
    const data = await fetch(`https://fakestoreapi.com/products/category/women's%20clothing?limit=${amount}`);
    const res = await data.json();
